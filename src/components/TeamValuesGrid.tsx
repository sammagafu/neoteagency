...
import { teamValues } from "@/lib/site-data";

export function TeamValuesGrid() {
      ...
      {teamValues.map((value, index) => {
        ...
        return (
          <button
            ...
            className={`interactive-card h-full rounded-2xl border p-8 text-left transition-all duration-300 sm:rounded-none sm:border-0 ${
              isActive
