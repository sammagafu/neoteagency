...
import { processPrinciples } from "@/lib/site-data";

export function ProcessPrinciplesGrid() {
      ...
      {processPrinciples.map((principle, index) => {
        ...
        return (
          <button
            ...
            className={`interactive-card group h-full rounded-2xl border p-8 text-left transition-all duration-300 sm:rounded-none sm:border-0 ${
              isActive
